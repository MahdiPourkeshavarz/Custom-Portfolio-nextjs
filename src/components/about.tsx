    ...
    >
      <div className="container mx-auto">
        <Fade
          ...
          triggerOnce={true}
        >
          <SectionHeading>درباره ی من</SectionHeading>
        </Fade>

        <div className="grid xl:grid-cols-2 lg:text-end">
          <div>
            <Fade
              direction="right"
              delay={600}
            ...
            <div className="text-lg mt-12 xl:mt-3">
              <div className="flex justify-start flex-col">
                <Fade
                  ...
                  triggerOnce={true}
                >
                  <h3 className="font-bold mt-6">مسیر حرفه ای من</h3>
                </Fade>
                <Fade
                  direction="up"
                  delay={600}
                ...
                <Fade
                  ...
                  triggerOnce={true}
                >
                  <h3 className="font-bold mt-6">چشم انداز کاری</h3>
                </Fade>
                <Fade
                  direction="up"
                  delay={1000}
